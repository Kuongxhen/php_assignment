        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            <a href="{{ route('admin.stock.dashboard') }}" class="btn btn-primary w-100 py-3 h-100">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('admin.products.index') }}" class="btn btn-info w-100 py-3 h-100">
                        ...
                        <div class="col-md-3">
                            <a href="{{ url('/api/v1/stock-alerts/stats') }}" target="_blank" class="btn btn-success w-100 py-3 h-100">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('products.index') }}" class="btn btn-secondary w-100 py-3 h-100">
                                <i class="fas fa-boxes d-block fs-3 mb-2"></i>
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="{{ url('/api/v1/products') }}" target="_blank" class="list-group-item list-group-item-action border-0 px-0">
                        ...
                        <a href="{{ url('/api/v1/stock-alerts') }}" target="_blank" class="list-group-item list-group-item-action border-0 px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="badge bg-success me-2">GET</span>
                        ...
                        <a href="{{ url('/api/v1/reorder-requests') }}" target="_blank" class="list-group-item list-group-item-action border-0 px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="badge bg-success me-2">GET</span>
                        ...
                        <a href="{{ url('/api/v1/payments') }}" target="_blank" class="list-group-item list-group-item-action border-0 px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="badge bg-success me-2">GET</span>
                        ...
                        <a href="{{ url('/api/v1/health') }}" target="_blank" class="list-group-item list-group-item-action border-0 px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-md-2 col-6 mb-3">
                            <a href="{{ route('admin.stock.dashboard') }}" class="text-decoration-none">
                        ...
                        <div class="col-md-2 col-6 mb-3">
                            <a href="{{ url('/api/v1/health') }}" target="_blank" class="text-decoration-none">
                                <div class="border rounded p-3 h-100 hover-shadow">
                        ...
                        <div class="col-md-2 col-6 mb-3">
                            <a href="{{ url('/api/v1/stock-alerts/stats') }}" target="_blank" class="text-decoration-none">
                                <div class="border rounded p-3 h-100 hover-shadow">
