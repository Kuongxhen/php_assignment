...
<section class="hero hero--split">
	<div class="wrap hero__split">
		<div class="panel panel--patient">
			...
			<form method="POST" action="{{ route('patient.login') }}" class="form">
				@csrf
				...
				<div class="row">
					...
					<a class="btn btn--ghost" href="{{ route('patient.register') }}">I’m new</a>
				</div>
			</form>
		</div>
	...
	<div class="wrap narrow">
		<div class="auth">
			...
			<form method="POST" action="{{ route('patient.login') }}" class="form">
				...
				<label class="field"><span>Email</span><input type="email" name="email" required></label>
				<label class="field"><span>Password</span><input type="password" name="password" required></label>
				<div class="form__row"><button type="submit" class="btn btn--gold">Sign In</button><a href="{{ route('patient.register') }}" class="link link--soft">Create account</a></div>
			</form>
		</div>
	</div>
</section>
