...
<head>
    ...
    <title><?php echo e(config('app.name', 'My Project')); ?></title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light mb-4" style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); backdrop-filter: blur(15px); -webkit-backdrop-filter: blur(15px); box-shadow: 0 2px 20px rgba(0, 0, 0, 0.08); border-bottom: 1px solid rgba(14, 165, 233, 0.1);">
        <div class="container">
            <a class="navbar-brand fw-bold" href="<?php echo e(url('/')); ?>" style="color: #0ea5e9; font-size: 1.4rem;">
                <i class="fas fa-cube me-2" style="color: #06b6d4;"></i><?php echo e(config('app.name', 'Inventory System')); ?>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('payment.*') ? 'active' : ''); ?>" href="<?php echo e(route('payment.index')); ?>">
                            <i class="fas fa-credit-card me-1"></i>Payments
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>" href="#" id="adminDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.products.create')); ?>">
                                <i class="fas fa-plus me-2"></i>Add Product
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><h6 class="dropdown-header">Stock Management</h6></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.stock.dashboard')); ?>">
                                <i class="fas fa-exclamation-triangle me-2"></i>Stock Alerts
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><h6 class="dropdown-header">API & Reports</h6></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('/api/v1/health')); ?>" target="_blank">
                                <i class="fas fa-heartbeat me-2"></i>API Health
                            </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('/api/v1/stock-alerts/stats')); ?>" target="_blank">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="apiDropdown">
                            ...
                            <li><a class="dropdown-item small" href="<?php echo e(url('/api/v1/products')); ?>" target="_blank">
                                <span class="badge bg-success me-2">GET</span>Products
                            </a></li>
                            <li><a class="dropdown-item small" href="<?php echo e(url('/api/v1/stock-alerts')); ?>" target="_blank">
                                <span class="badge bg-success me-2">GET</span>Stock Alerts
                            </a></li>
                            <li><a class="dropdown-item small" href="<?php echo e(url('/api/v1/reorder-requests')); ?>" target="_blank">
                                <span class="badge bg-success me-2">GET</span>Reorder Requests
                            </a></li>
                            <li><a class="dropdown-item small" href="<?php echo e(url('/api/v1/payments')); ?>" target="_blank">
                                <span class="badge bg-success me-2">GET</span>Payments
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('/api/documentation')); ?>" target="_blank">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(url('/')); ?>"><i class="fas fa-home me-1"></i>Home</a>
                    </li>
                    <?php if(request()->routeIs('products.*')): ?>
                        <li class="breadcrumb-item active">
                            <i class="fas fa-boxes me-1"></i>Products
                        </li>
                    <?php elseif(request()->routeIs('payment.*')): ?>
                        <li class="breadcrumb-item active">
                            <i class="fas fa-credit-card me-1"></i>Payments
                        </li>
                    <?php elseif(request()->routeIs('admin.*')): ?>
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-shield-alt me-1"></i>Admin</a>
                        </li>
                        <?php if(request()->routeIs('admin.stock.*')): ?>
                            <li class="breadcrumb-item active">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myproject/resources/views/layouts/app.blade.php ENDPATH**/ ?>