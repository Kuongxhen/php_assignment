...
<script>
const API_BASE = '<?php echo e(url("/api/v1")); ?>';
let alertsData = [];
let reordersData = [];
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myproject/resources/views/admin/dashboard/stock-dashboard.blade.php ENDPATH**/ ?>